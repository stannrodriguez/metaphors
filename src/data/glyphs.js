...
export function buildGlyphs({ w, d, a }, animate = false) {
  ...
  return {
    ...
    map: `
      ...
      <path d="M27 56 Q40 46 52 50 Q64 54 68 42" stroke="${a}" stroke-width="2" stroke-dasharray="3 4" fill="none" stroke-linecap="round"/>
      <path d="M65 39 L71 45 M71 39 L65 45" stroke="${a}" stroke-width="2" fill="none" stroke-linecap="round"/>`,

    river: `
      <path d="M18 32 Q28 26 38 32 T58 32 T78 32" stroke="${w}" stroke-width="3" fill="none" stroke-linecap="round"/>
      <path d="M18 50 Q28 44 38 50 T58 50 T78 50" stroke="${d}" stroke-width="2.2" fill="none" stroke-linecap="round"/>
      <path d="M18 68 Q28 62 38 68 T58 68 T78 68" stroke="${w}" stroke-width="3" fill="none" stroke-linecap="round"/>
      <circle cx="52" cy="49" r="3.4" fill="${a}"/>`,
    ...
    battery: `
      ...
      <rect x="68" y="44" width="7" height="10" rx="2" fill="${w}"/>
    ...
    whetstone: `
      ...
      <path d="M70 30 L76 24 M74 34 L81 31" stroke="${a}" stroke-width="2.2" fill="none" stroke-linecap="round"/>`,
    ...
    ratchet: `
      ...
      <path d="M74 22 L60 32 L72 40 Z" fill="${a}"/>
    ...
    trellis: `
      ...
      <circle cx="44" cy="58" r="2.6" fill="${a}"/>
      <circle cx="56" cy="40" r="2.6" fill="${a}"/>`,
    ...
    magnet: `
      ...
      <path d="M26 34 Q14 48 26 62" stroke="${d}" stroke-width="1.6" stroke-dasharray="3 4" fill="none" stroke-linecap="round"/>
      <path d="M70 34 Q82 48 70 62" stroke="${d}" stroke-width="1.6" stroke-dasharray="3 4" fill="none" stroke-linecap="round"/>
      <circle cx="22" cy="72" r="1.8" fill="${d}"/>
    ...
    vortex: `
      ...
      <line x1="73" y1="25" x2="82" y2="18" stroke="${a}" stroke-width="2" stroke-dasharray="3 3" stroke-linecap="round"/>`,

    abyss: `
      <ellipse cx="48" cy="44" rx="26" ry="8" stroke="${w}" stroke-width="2.5" fill="none" stroke-linecap="round"/>
      <path d="M30 52 Q48 62 66 52" stroke="${d}" stroke-width="2" fill="none" stroke-linecap="round"/>
      <path d="M36 60 Q48 68 60 60" stroke="${d}" stroke-width="1.6" fill="none" stroke-linecap="round"/>
      <path d="M42 67 Q48 72 54 67" stroke="${d}" stroke-width="1.3" fill="none" stroke-linecap="round"/>
      <circle cx="48" cy="25" r="3" fill="${a}"/>
      <line x1="48" y1="28" x2="48" y2="33" stroke="${a}" stroke-width="2" stroke-linecap="round"/>`,

    spotlight: `
      <circle cx="28" cy="22" r="4.5" fill="${w}"/>
      <path d="M28 22 L58 74 L18 74 Z" fill="${d}" opacity="0.45"/>
      <circle cx="38" cy="66" r="4" fill="${a}"/>
      <circle cx="70" cy="36" r="1.8" fill="${d}"/>
      <circle cx="78" cy="56" r="1.6" fill="${d}"/>
      <circle cx="64" cy="22" r="1.5" fill="${d}"/>`,
    ...
    mask: `
      ...
      <ellipse cx="40" cy="44" rx="4.5" ry="3" fill="${w}"/>
      <ellipse cx="56" cy="44" rx="4.5" ry="3" fill="${w}"/>
